...
def create_model_RF(file_path, model_name):
    try:
        if os.path.exists(f"models/rf/{model_name}"):
...
def create_model_IF(file_path, model_name):
    try:
        if os.path.exists(f"models/if/{model_name}"):
...
def create_model_DEEPCASE(file_path, model_name):
    try:
        if os.path.exists("models/deepcase/contextbuilder/ContextBuilder.save") and  os.path.exists(f"models/deepcase/interpreter/{model_name}") :
